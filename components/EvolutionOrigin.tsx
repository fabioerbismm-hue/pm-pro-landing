          ...
          <div className="relative grid gap-12 lg:grid-cols-[1.15fr_.85fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-muted">
                ...
                Media Groups nei processi di marketing e acquisizione per il settore immobiliare.
              </p>
              ...
              >
                Conosci Evolution Media Groups <ArrowUpRight size={17} aria-hidden="true" />
              </a>
            </div>

            <div className="grid gap-4">
              <article className="rounded-2xl border border-white/10 bg-ink/60 p-6">
                <Users className="text-sky" aria-hidden="true" />
                <p className="eyebrow mt-6">CO-FOUNDER · OPERATIONS</p>
